...
function getQuery(options)
{
    ...
    return new Promise((resolve,reject)=>{
        ...
        if(exchange === 'NSE')
        {
            ...
            query = `SELECT TIMESTAMP AS DATE , OPEN AS OPEN , HIGH AS HIGH , LOW AS LOW , CLOSE AS CLOSE , TOTTRDQTY AS VOLUME FROM nse_bhav WHERE SYMBOL='${code}'`;
