...
import { drawOnCanvas, renderSVG } from "./LabelEdgeIndicator";
...
class LabelEdgeCoordinate extends Component {
	constructor(props) {
		super(props);
...
LabelEdgeCoordinate.defaultProps = {
	yAxisPad: 0,
	rectWidth: 50,
	rectHeight: 20,
	orient: "left",
...
function helper(props, moreProps) {
	...
	const { orient, at, rectWidth, rectHeight, rectRadius, displayFormat, dx ,labelText } = props;
...
export default LabelEdgeCoordinate;
