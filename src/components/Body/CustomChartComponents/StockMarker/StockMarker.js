...
import { drawOnCanvas, renderSVG } from "./StockMarkerCoordinate";
...
export class StockMarker extends Component {
	constructor(props) {
		super(props);
...
StockMarker.defaultProps = {
	className: "react-stockcharts-stockmarker",
	type: "horizontal",
	orient: "left",
	edgeAt: "left",
	textFill: "#FFFFFF",
...
function getEdge(props, moreProps, item) {
	...
	const { yAccessor, fill, textFill, rectHeight, rectWidth, arrowWidth, labelText } = props;
